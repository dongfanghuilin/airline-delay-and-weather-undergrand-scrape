...
# cat_var = ['UniqueCarrier','Dest', 'Diverted']
...
sample = pd.read_csv('2007_ORD_formated_1.csv', encoding = "ISO-8859-1")
...
# tb1 = pd.pivot_table(sample, values=['CRSElapsedTime','ArrDelay','DepDelay'], 
# 	columns = ['Date'], aggfunc = [np.mean, np.std])
